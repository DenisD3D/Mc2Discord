...
public class EnvGenerator {
    ...
    private static String getErrorComment() {
        ...
        try {
            return messages[(int)(System.nanoTime() % (long)messages.length)];
    ...
    private void initDetails() {
        this.systemDetails.setDetail("Minecraft Version", () -> FMLCommonHandler.instance().getMinecraftServerInstance().getMinecraftVersion());
        ...
        this.systemDetails.setDetail("JVM Flags", () -> {
            ...
            List<String> list = runtimemxbean.getInputArguments().stream().filter((p_211566_0_) -> p_211566_0_.startsWith("-X")).collect(Collectors.toList());
