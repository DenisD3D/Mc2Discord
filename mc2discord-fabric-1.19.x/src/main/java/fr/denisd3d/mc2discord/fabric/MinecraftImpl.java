...
public class MinecraftImpl implements IMinecraft {
    ...
    public String getPlayerNameFromUUID(UUID uuid) {
        return Optional.of(Mc2DiscordFabric.server.getProfileCache()).flatMap(gameProfileCache -> gameProfileCache.get(uuid)).map(GameProfile::getName).orElse(uuid.toString());
    }
