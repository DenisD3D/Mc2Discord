...
dependencies {
    ...
    // Config
    implementation(group = "com.github.denisd3d", name = "config4j", version = "1.0.3")
    implementation(group = "com.electronwill.night-config", name = "toml", version = "3.6.0") // Shipped in Forge
