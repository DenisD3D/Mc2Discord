                ...
                .then(Commands.literal("status").executes(context -> {
                    ...
                    return 1;
                        ...
                        .then(Commands.literal("reload").executes((context) -> {
                            try {
                                context.getSource().sendSuccess(Component.literal(M2DCommands.reloadHiddenPlayers()), false);
                                return 1;
                            } catch (IOException e) {
                        ...
                        .then(Commands.literal("reload").executes((context) -> {
                            try {
                                context.getSource().sendSuccess(Component.literal(M2DCommands.reloadLinkedPlayers()), false);
                                return 1;
                            } catch (IOException e) {
                                throw new RuntimeException(e);
                            }
